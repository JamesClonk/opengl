...
func main() {
	app := NewSimpleApp(640, 480, "Go GLFW3 Texture Lighting Example", draw)
	defer app.Destroy()

	cube := NormalTextureVertices{
		NormalTextureVertex{
	...
	*/
	...
	shader = NewNormalTexturedShader(&cube, indices, texture, vertexShaderSource, fragmentShaderSource)
